        ...
        <template slot-scope="scope">
          <el-popover v-model="scope.row.visible" placement="top" width="120">
            ...
            <div class="tac m0">
              ...
              <el-button type="primary" size="mini" @click="removeScheduler(scope.row.scheduler_id)">确定</el-button>
            </div>
            <el-button slot="reference" type="danger" icon="el-icon-delete" circle size="mini" />
          </el-popover>
          <el-button class="ml10" type="warning" icon="el-icon-video-pause" circle size="mini" @click="stopScheduler(scope.row.scheduler_id)" />
          <el-button class="ml5" type="primary" icon="el-icon-video-play" circle size="mini" @click="startScheduler(scope.row.scheduler_id)" />
        </template>
      </el-table-column>
    </el-table>
