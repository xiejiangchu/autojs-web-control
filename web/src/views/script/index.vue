<template>
  <div class="script-container">
    <div class="script-header">
      <el-input size='mini' style='margin-left:20px;' autosize v-model="scriptData.script_name" placeholder="请输入内容"></el-input>
      <div class="actions" />
      <div class="mr20">
        <el-button v-loading="bustling" icon="el-icon-suitcase" plain circle size="mini" @click="saveScript" />
      </div>
    </div>
    <div style="position: relative;">
      <article id="code" ref="code" v-loading="listLoading" :style="{ height: codeHeight }" element-loading-text="Loading" />
    ...
    saveScript() {
      ...
      request({
          url: this.scriptData.script_id ?
            "/script/update_script" : "/script/add_script",
          method: "post",
