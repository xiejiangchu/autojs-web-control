...
let Script = (() => {
    let Script = class Script {
        ...
        get_device_list(query) {
            return __awaiter(this, void 0, void 0, function* () {
                const scripts = yield script_model_1.default.getScriptAll(query.pageNum || 1, query.pageSize || 10);
                const count = yield script_model_1.default.count();
                return result_utils_1.ResultUtils.success({ scripts: scripts, total: count });
            });
        }
        add_device(body) {
            return __awaiter(this, void 0, void 0, function* () {
