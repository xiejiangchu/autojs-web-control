...
class DeviceModel extends base_model_1.default {
    ...
    getByName(uname) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.$db.table(exports.tableName).where({ uname }).findOrEmpty();
        });
    }
    changePassword(admin_id, newPassword) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.$db.table(exports.tableName).where({ admin_id }).update({
